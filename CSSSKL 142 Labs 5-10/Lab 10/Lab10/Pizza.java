...
public class Pizza {
    ...
    public double calcCost() {
        ...
        double extraMeat = numberOfMeat * 2;
        cost = cost + extraMeat;
        cost = cost + numberOfVeggies;
        return cost;
    }
    ...
    public String getDescription() {
        ...
        return size + " pizza, " + isVegan + numberOfMeat + " meat topping, " + numberOfVeggies + " veggie topping: $" + calcCost() +  " dollars.";
    }
}
