...
public class Lab8 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(stretch(a3));
        System.out.println(stretch(a4));
    }
    ...
    public static double median(double[] array) {
        ...
        if(array.length % 2 != 0){
            ...
            double average = 0;
            middle = array.length / 2;
            secondMid = array.length / 2 - 1;
            average = (array[middle] + array[secondMid]) / 2; //params are important
            return average;
        }
    }
    ...
    public static int[] stretch(int[] array) {
        ...
        int index = 0;
        for(int i = 0; i < array.length; i++){
            firstValue = array[i] / 2;
            secondValue = array[i] - firstValue;
            System.out.println(firstValue + " " + secondValue);
            newArray[index] = firstValue;
            newArray[index + 1] = secondValue;
            index +=2;
        }
